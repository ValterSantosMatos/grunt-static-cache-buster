...
exports._static_cache_buster = {
  default_options: function (test) {
    ...
    var bustedFile1 = grunt.file.exists('tmp/test/fixtures/file-to-bust/file-to-bust-79d310bfe9ba9930c28043700467788e.js');
    test.equal(true, bustedFile1, 'the js file should be busted.');
    
    var bustedFile2 = grunt.file.exists('tmp/test/fixtures/file-to-bust.1.js-79d310bfe9ba9930c28043700467788e.js');
